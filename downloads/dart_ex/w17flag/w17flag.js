...
(function dartProgram() {
  ...
  G = {
    main: function() {
      ...
      t2 = J.get$onClick$x(t1.querySelector("#ja"));
      t3 = H.getTypeArgumentByIndex(t2, 0);
      ...
      W._EventStreamSubscription$(t1._target, t1._eventType, H.functionTypeCheck(new G.main_closure5(), {func: 1, ret: -1, args: [t2]}), false, t2);
    },
    drawru: function(ctx) {
      ...
      ctx.fillRect(0, 66, 300, 200);
      ctx.fillStyle = "#ff0000";
      ctx.fillRect(0, 132, 300, 200);
    },
